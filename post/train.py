...
if __name__ == "__main__":
	...
	opts = Options(args.hidden, args.epochs, args.min_epochs, \
		...
		args.vggnarrow, args.mk3, args.mk4, args.mk5, \
		args.resnet18, \
		args.o + ".p")
